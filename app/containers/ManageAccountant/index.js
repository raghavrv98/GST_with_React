...
export class ManageAccountant extends React.Component {
  ...
  getAccountant = (month, year, accountantType) => {
    // axios.get(`http://localhost:3000/accountants/${month}/${year}/${accountantType}`)
    axios.get(`http://localhost:3000/accountants/${month}/${year}`)
      .then((res) => {
  ...
  deleteAccountant = (id) => {
    axios.delete(`http://localhost:3000/accountant/${id}`)
      .then((res) => {
  ...
  render() {
    const columns = [
      ...
      },
      {
        ...
        filterable: true,
        Cell: row => (
          <div className="onClick-cell-r">{row.original.name}</div>
        )
      },
      {
            ...
            <div className="row">
              ...
              <div className="col-xs-4 col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                <select disabled={true} id="accountantType" onChange={this.nameChangeHandler} value={this.state.accountantType} className="year-month-border-r"
                  name="lectureId">
                  <option value="0">Select accountant</option>
