...
export class LoginPage extends React.Component {
  ...
  else if(this.state.payload.name === localStorage.getItem("admin") && this.state.payload.password === localStorage.getItem("password")){
      ...
      <div>
        ...
        <div className="loginBackgroundImage-r">
          <div className="loginLayout-r">
            <div className="container outer-box-login-r">
